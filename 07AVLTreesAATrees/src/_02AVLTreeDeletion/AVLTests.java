...
public class AVLTests {
    ...
    public void height_RootRight() {
        ...
        Assert.assertEquals(1, avl.getRoot().getRight().height);
    }
    ...
    public void height_RootLeft() {
        ...
        // Assert
        Assert.assertEquals(2, avl.getRoot().height);
        Assert.assertEquals(1, avl.getRoot().getLeft().height);
    }
    ...
    public void rebalance_TestHeightOneNodes() {
        ...
        // Assert
        Assert.assertEquals(1, avl.getRoot().getLeft().getLeft().height); // 1
        Assert.assertEquals(1, avl.getRoot().getLeft().getRight().height); // 3
        Assert.assertEquals(1, avl.getRoot().getRight().getLeft().height); // 5
        Assert.assertEquals(1, avl.getRoot().getRight().getRight().getLeft().height); // 7
        Assert.assertEquals(1, avl.getRoot().getRight().getRight().getRight().height); // 9
    }
    ...
    public void rebalance_TestHeightTwoNodes() {
        ...
        // Assert
        Assert.assertEquals(2, avl.getRoot().getLeft().height); // 2
        Assert.assertEquals(2, avl.getRoot().getRight().getRight().height); // 8
    }
    ...
    public void rebalance_TestHeightThreeNodes() {
        ...
        // Assert
        Assert.assertEquals(3, avl.getRoot().getRight().height); // 6
    }
    ...
    public void height_DeleteRoot() {
        ...
        // Nodes of height 1
        Assert.assertEquals(1, root.getLeft().getLeft().height); // 1
        Assert.assertEquals(1, root.getLeft().getRight().height); // 3
        Assert.assertEquals(1, root.getRight().getLeft().getRight().height); // 7
        Assert.assertEquals(1, root.getRight().getRight().height); // 9

        // Nodes of height 2
        Assert.assertEquals(2, root.getLeft().height); // 2
        Assert.assertEquals(2, root.getRight().getLeft().height); //6

        // Nodes of height 3
        Assert.assertEquals(3, root.getRight().height); // 8
    ...
    public void height_DeleteMultiple() {
        ...
        // Nodes of height 1
        Assert.assertEquals(Integer.valueOf(3), root.getLeft().getLeft().value);
        Assert.assertEquals(1, root.getLeft().getLeft().height); // 3

        Assert.assertEquals(Integer.valueOf(7), root.getRight().getLeft().value);
        Assert.assertEquals(1, root.getRight().getLeft().height); // 7

        Assert.assertEquals(Integer.valueOf(9), root.getRight().getRight().value);
        Assert.assertEquals(1, root.getRight().getRight().height); // 9

        // Nodes of height 2
        Assert.assertEquals(Integer.valueOf(5), root.getLeft().value);
        Assert.assertEquals(2, root.getLeft().height); // 5

        Assert.assertEquals(Integer.valueOf(8), root.getRight().value);
        Assert.assertEquals(2, root.getRight().height); // 8
    }
